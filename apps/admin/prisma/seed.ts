...
async function main() {
  ...
  const blogPosts = [
    {
      ...
      image:
        'https://media.product.which.co.uk/prod/images/original/3cc919e52b08-apple-wwcd23-vision-pro-lifestyle-working-230605.jpg',
    ...
    },
    {
      ...
      title:
        'How AI-Generated Content Will Impact the Future of Architectural Engineering',
    ...
    },
    {
      ...
      image:
        'https://intl.nothing.tech/cdn/shop/files/PC2_2160x.jpg?v=1680179311',
  ...
  const banners = [
    {
      image:
        'https://marketplace.canva.com/EAFgoIbXL34/1/0/1600w/canva-beige-minimalist-mother%27s-day-sale-promotional-banner-YpclZeIn87Q.jpg',
      label: 'Something',
    },
    {
      image:
    ...
    {
      image:
        'https://marketplace.canva.com/EAFhXw50O8Q/1/0/1600w/canva-beige-minimalist-fashion-collection-photo-collage-banner-VTuOcmKhSd4.jpg',
      label: 'Something',
    },
    {
      image:
        'https://marketplace.canva.com/EAFOMzwkPtk/1/0/1600w/canva-chic-website-homepage-fashion-collage-banner-QtOtaBX5FCE.jpg',
      label: 'Something',
    },
  ]
